...
const Storage = {
    ...
    // Simple Auth (Demo purposes - in production use real backend)
    // Default admin:admin
    async authenticate(username, password) {
        const adminUser = {
            username: 'admin',
            // Simple hashed simulation for "strong encryption" requirement
        ...
        if (username === adminUser.username && hashHex === adminUser.passwordHash) {
